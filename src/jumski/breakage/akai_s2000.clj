...
(def ^:private labels-to-notes
  ...
  {:chat1 :c#3 :chat2 :d#3 :chat3 :f#3 :chat4 :g#3 :chat5 :a#3 :chat-drop :c#4

   :kick1 :e2 :kick2 :f2 :kick3 :g2 :kick4 :a2 :kick5 :b2 :kick6 :c3 :kick-drop :d3
   :snare1 :f3 :snare2 :g3 :snare3 :a3 :snare4 :b3
   :snare5 :c4 :snare6 :d4 :snare7 :e4 :snare8 :f4 :snare-drop :g4})
